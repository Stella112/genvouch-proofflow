# GenVouch: AI-Native Decentralized Credit Union

![GenVouch Banner](https://genvouch-proofflow.vercel.app/og-image.png)

**Live Demo:** [genvouch-proofflow.vercel.app](https://genvouch-proofflow.vercel.app/)  
...
Currency Symbol: GEN
Built For
Built for the DoraHacks GenLayer Bradbury Hackathon.

```bash
git clone https://github.com/Stella112/genvouch-proofflow.git
